...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>Courses</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
...
echo "<h2>Semeter#1</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course0");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#2</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse1");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#3</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse2");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#4</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse3");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#5</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse4");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#6</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse5");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#7</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse6");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#8</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM cscourse7");
odbc_result_all($resultset,"border=1");
?>	</p>
