...
<div id="wrapper">
		...
		<div id="top">
			<div class="centercolumn">
				<div id="top-navigation">
					<ul id="topnav">
							<li class="home"><a href="./lhome.html">Home</a></li>
						
	
						<li><a href="./librarian.php">Library</a></li>
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>Books Entry</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
					<h2></h2>
					<p></p>
					<div id="contact_form">
						  <form id="contact" action="addbooks.php" method="post">
							<fieldset>
							  <label for="name" id="name_label">Serial Number</label>
							  <input type="text" name="sn" id="nam" size="30" value="" class="input" />
							  <span class="error" id="name_error">Please enter number !</span>
							  <br style="clear:both" />
							  
							   <label for="id" id="id">Book Title</label>
							  <input type="text" name="bt" id="idd" size="30" value="" class="input" />
							  <span class="error" id="id_error">Please enter Title !</span>
							  <br style="clear:both" />
							  
							 <label for="email" id="email_label">Author Name</label>
							  <input type="text" name="an" id="email" size="30" value="" class="input" />
							  <span class="error" id="email_error">Please Enter Author Name !</span>
							 <br style="clear:both" />
							 
							 <label for="email" id="email_label">Availibility</label>
							  <input type="text" name="av" id="email" size="30" value="" class="input" />
							  <span class="error" id="email_error">Please Fill this Field !</span>
							 <br style="clear:both" />
							 
							 <label for="email" id="email_label">Quantity</label>
							  <input type="text" name="qn" id="quan" size="30" value="" class="input" />
							  <span class="error" id="email_error">Please Fill this Field !</span>
							 <br style="clear:both" />
...
if($INSERT="INSERT INTO library VALUES('$n','$id','$an','$avbl','$quan')")
{
