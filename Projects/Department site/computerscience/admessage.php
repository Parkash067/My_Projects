...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>Message Box</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
					<h2>Text Field</h2>
					<p></p>
					<div id="contact_form">
						  <form id="contact" action="admessage.php" method="post">
							<fieldset>
							 
							  <br style="clear:both" />
							  <label for="msg" id="msg_label">Your Message</label>
							 <textarea cols="250" rows="20" name="msg" id="m" class="input"></textarea>
...
if($INSERT="INSERT INTO admin_message VALUES('$mg')")
{
...
$resultset=odbc_exec($conn, "SELECT * FROM admin_message");
