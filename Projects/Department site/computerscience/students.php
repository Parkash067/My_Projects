...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>A Little About Ubitians</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
					<h1>Programming</h1>
					<p>Computer programming (often shortened to programming) is a process that leads from an original formulation of a computing problem to executable programs. It involves activities such as analysis, understanding, and generically solving such problems resulting in an algorithm.  </p>
					...
					<h4>Networking</h4>
					<p>A network is a group of two or more computer systems linked together. There are many types of computer networks, including</p>
				
					<hr />
					<h2>Future</h2>
					<p><span class="highlight1">Computing software and systems are becoming increasingly integral to our lives, revolutionising the world in which we live, work and communicate</span>.The Computer Science major will provide you with the knowledge and skills required to help revolutionise the world in which we live and work, and the way that we communicate. </p>
					<hr />
					
					<h2>Computer Science</h2>
					<div class="img-frame6 alignleft"><img src="./images/fw-pic1.jpg" alt="" class=" preloader" height="123" width="278" /></div> 
					<p align="justify">Computer Science (abbreviated CS or CompSci) is the scientific and practical approach to computation and its applications. It is the systematic study of the feasibility, structure, expression, and mechanization of the methodical processes (or algorithms) that underlie the acquisition, representation, processing, storage, communication of, and access to information. </p>
					<p align="justify">Its subfields can be divided into a variety of theoretical and practical disciplines. Some fields, such as computational complexity theory (which explores the fundamental properties of Computational and intractable problems), are highly abstract, while fields such as computer graphics emphasize real-world visual applications.</p>
					<div class="img-frame6 alignright"><img src="./images/fw-pic2.jpg" alt="" class=" preloader"  height="123" width="278"  /></div>
					<p align="justify">Still other fields focus on the challenges in implementing computation. For example, programming language theory considers various approaches to the description of computation, whilst the study of computer programming itself investigates various aspects of the use of programming language and complex systems. Human-computer interaction considers the challenges in making computers and computations useful, usable, and universally accessible to 
humans.</p>
					<p align="justify">For example, programming language theory considers various approaches to the description of computation, whilst the study of computer programming itself investigates various aspects of the use of programming language and complex systems. Human-computer interaction considers the challenges in making computers and computations useful, usable, and universally accessible to humans. </p>
					<hr />
			...
			<p>					<code>&lt;?php echo('Hello world!'); ?&gt;</code></p>
					...
					<div class="widget-area">
						<div class="widget-box">
							<ul>
								...
								<h2 class="widget-title">More About Us</h2>
								<div class="lineleft">
								...
								<ul>
									...
									<li><a href="./updates.php">Teacher Updates</a></li>
									<li><a href="./aupdate.php">Admin Updates</a></li>
									<li><a href="./gptable.php">Grade Point Table</a></li>
									<li><a href="./fc.php">Faculty Record</a></li>
					...
					<div class="widget-area">
							<ul>
								<li class="widget-container">
								<h2 class="widget-title">Artificial Intelligence</h2>
								<img src="./images/tf1.jpg" alt="" />
								<img src="./images/tf2.jpg" alt="" height="150" width="213" />
								</li>
							</ul>
					</div><!-- end widget-area -->
					<div class="widget-area">
