						  ...
						  <form id="contact" action="">
							<fieldset>
							  <label for="name" id="name_label">First Name</label>
							   <input type="text" name="name" id="name" size="30" value="" class="input" />
							  <span class="error" id="name_error">Enter First name !</span>
							  <label for="name" id="name_label">	Last Name</label>
							   <input type="text" name="name" id="name" size="30" value="" class="input" />
							  <span class="error" id="name_error">Enter Last name !</span>
							  <br style="clear:both" /><br />
							  
							 <label for="Student Id" id="Student_Id">Student_ID</label>
							  <input type="text" name="std" id="stid" size="30" value="" class="input" />
