...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>Saeed Ali</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
...
$resultset=odbc_exec($conn, "SELECT * FROM teachercourse WHERE FacultyMember='SaeedAli'");
