...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner">
			<div class="centercolumn">
				<div id="page-title"><h1>Library</h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
						<div class="post hentry">
							...
							<div class="img-frame3"><img src="./images/post1.jpg" alt="" title="post1" class="preloader" width="605" height="207"/></div>
							<p align="justify">A library is an organized collection of sources of information and similar resources, made accessible to a defined community for reference or borrowing. It provides physical or digital access to material, and may be a physical building or room, or a virtual space, or both.. 
							</div>
							<div class="entry-meta">
								 <a href="./books.php">Books Detail</a><br />
								 				
<?php
$conn = odbc_connect('bwsqldata','',''); 
$resultset=odbc_exec($conn, "SELECT * FROM library");
