...
$resultset=odbc_exec($conn, "SELECT * FROM course2");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#3</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course3");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#4</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course4");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#5</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course5");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#6</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course6");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#7</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course7");
odbc_result_all($resultset,"border=1");

echo "<h2>Semeter#8</h2>";
$resultset=odbc_exec($conn, "SELECT * FROM course8");
odbc_result_all($resultset,"border=1");
?>	</p>
