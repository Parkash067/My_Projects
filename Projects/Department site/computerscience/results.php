...
<div id="wrapper">
	...
	<div id="container-content">
		<div id="content-inner"><?php
$conn = odbc_connect('bwsqldata','',''); 
$resultset=odbc_exec($conn, "SELECT * FROM std_marks 
Join Tcourse 
on std_marks.CourseNumber=Tcourse.CourseNumber");
odbc_result_all($resultset,"border=1");
?>
			<div class="centercolumn">
				<div id="page-title"><h1></h1></div><!-- end #page-title -->
				<div id="page-content">
					<div class="col-left">
